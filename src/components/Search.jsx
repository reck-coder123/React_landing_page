...
function Search() {
  ...
  return (
    <>
    {isDesktopOrLaptop && <div className="search relative h-[65rem] px-[5rem] bg-[#081730] pt-[18rem] pb-[10rem] mt-[-15rem] z-[1] flex items-center justify-between rounded-b-[5rem]">
      {/* left side */}
    ...
    {isTabletOrMobile && <div className='search relative h-[95rem] px-[5rem] bg-[#081730] pt-[10rem] pb-[10rem]
    mt-[-15rem] z-[1] flex items-center justify-between rounded-b-[5rem] '>
      {/*left side */}
      <div className="left flex-1 z-[1] w-[400px] h-[700px] absolute top-[32rem] left-4 ">
        <motion.img
          variants={bg}
          animate={`${elementIsVisible}`}
          transition={{
        ...
        />
        <motion.img src={require("../img/d1.png")}

          alt=""
          className="w-[16rem] top-[26rem] absolute" />{" "}
        <motion.img src={require("../img/d2.png")}
          alt=""
          className="w-[9rem] absolute top-[32.7rem] left-[7rem]" />{" "}
        <motion.img src={require("../img/d3.png")}
          variants={redimg}
          animate={`${elementIsVisible}`}
          transition={{
            duration: 1.2,
          ...
          alt=""
          className="w-[9rem] top-[33rem] left-[17rem] absolute" />
        <motion.img src={require("../img/d4.png")}
          variants={musicimg}
          animate={`${elementIsVisible}`}
          transition={{
            duration: 1,
      ...
      <div className="right flex items-start flex-col justify-start flex-1 h-[100%] pt-[9rem]">
        ...
        <div className="searchbar flex justify-start w-[100%]">
          ...
          />
          {/* SearchIcon */}
          <div className="searchIcon flex flex-1 items-center rounded-xl ml-4 bg-gradient-to-bl from-[#F3071D] to-[#E600FF] p-4 h-[3rem] w-[45px]">
            <img
              src={require("../img/search.png")}
              alt=""
              className="w-[1.5rem]"
