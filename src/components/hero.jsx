...
function Hero() {
  ...
  return (
    <>
    {isDesktopOrLaptop && <VisibilitySensor
    ...
    {isTabletOrMobile && <VisibilitySensor
      onChange={(isVisible) => setElementIsVisible(isVisible)}
      minTopValue={300}
    >
      <div className="wrapper bg-[#081730] flex flex-col items-center justify-between px-[5rem] rounded-b-[5rem] w-[100%] h-[45rem] relative z-[3]">
        {/* left side */}
        <div className="headings flex flex-col items-start justify-center h-[100%] text-[3rem]">
          <span>Experience The</span>{" "}
          <span>
        ...
        {/* right side */}
        <div className="images absolute w-[70%]  justify-start left-0 top-[140%] hidden">
          <motion.img
            variants={bg}
            animate={`${elementIsVisible}`}
            transition={{ duration: 1, type: "ease-out" }}
